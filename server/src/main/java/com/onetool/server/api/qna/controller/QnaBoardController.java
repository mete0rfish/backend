...
public class QnaBoardController {
    ...
    public ApiResponse<String> qnaWrite(Principal principal, @Valid @RequestBody QnaBoardRequest.PostQnaBoard request){
        log.info("쓰기");
     ...
     */
    @GetMapping("/{qnaId}")
    public ApiResponse<QnaBoardResponse.QnaBoardDetailResponse> qnaDetails(Principal principal, @PathVariable Long qnaId){
    ...
    public ApiResponse<String> getQnaToUpdate(Principal principal, @PathVariable Long qnaId, @Valid @RequestBody QnaBoardRequest.PostQnaBoard request){
    ...
    public ApiResponse<String> qnaUpdate(Principal principal, @PathVariable Long qnaId, @Valid @RequestBody QnaBoardRequest.PostQnaBoard request){
        qnaBoardService.updateQna(principal, qnaId, request);
